...
public class ClsListaReproduccion {
    ...
    //-----------------------------------------METODOS--------------------------------------------------
    //-------------------------------------------------------------------------------------------------- 
    public void agregarLista(ClsEntidadListaReproduccion lista_reproduccion){
        try{
            CallableStatement statement=connection.prepareCall("{call SP_I_ListadeReproduccion(?,?)}");
            //statement.setString("idListas_reproduccion",lista_reproduccion.getNombrelista());
            statement.setString("pnombreLista",lista_reproduccion.getNombrelista());
            statement.setString("pUsuario_Idusuario",lista_reproduccion.getIdusuario());
            statement.execute();
