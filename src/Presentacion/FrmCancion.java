...
public class FrmCancion extends javax.swing.JInternalFrame {
 ...
 @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        tabCancion.setBackground(new java.awt.Color(153, 153, 255));

        pBuscar.setBackground(new java.awt.Color(153, 255, 153));
        pBuscar.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        rbtnCodigo.setFont(new java.awt.Font("Segoe UI Black", 0, 13)); // NOI18N
        rbtnCodigo.setText("Id");
        pBuscar.add(rbtnCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, -1, -1));

        rbtnGenero.setFont(new java.awt.Font("Segoe UI Black", 0, 13)); // NOI18N
        rbtnGenero.setText("Genero");
        pBuscar.add(rbtnGenero, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, -1, -1));

        rbtnAutor.setFont(new java.awt.Font("Segoe UI Black", 0, 13)); // NOI18N
        rbtnAutor.setText("Autor");
        pBuscar.add(rbtnAutor, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 10, -1, -1));

        rbtnTitulo.setFont(new java.awt.Font("Segoe UI Black", 0, 13)); // NOI18N
        rbtnTitulo.setText("Titulo");
        pBuscar.add(rbtnTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 10, -1, -1));

        txtBusqueda.setBackground(new java.awt.Color(255, 204, 255));
        txtBusqueda.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtBusquedaKeyReleased(evt);
            }
        });
        pBuscar.add(txtBusqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 50, 258, -1));
        ...
        rbtnUsuario.setFont(new java.awt.Font("Segoe UI Black", 0, 13)); // NOI18N
        rbtnUsuario.setText("Usuario");
        pBuscar.add(rbtnUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 10, -1, -1));

        tabCancion.addTab("Buscar", pBuscar);

        pNuevo.setBackground(new java.awt.Color(255, 153, 153));
        ...
        txtIdCancion.setBackground(new java.awt.Color(255, 255, 153));
        ...
        txtUsuario_idusuario.setBackground(new java.awt.Color(255, 255, 153));
        ...
        btnNuevo.setBounds(560, 60, 90, 25);
        ...
        btnGuardar.setBounds(560, 90, 90, 25);
        ...
        btnModificar.setBounds(560, 120, 90, 25);
        ...
        btnCancelar.setBounds(560, 150, 90, 25);
        ...
        btnSalir.setBounds(560, 180, 90, 25);
