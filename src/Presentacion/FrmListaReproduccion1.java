...
public class FrmListaReproduccion1 extends javax.swing.JInternalFrame {
   ...
   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        pBuscar.setBackground(new java.awt.Color(51, 204, 255));
        ...
        buttonGroup1.add(rbtNombreLista);
        rbtNombreLista.setFont(new java.awt.Font("Segoe UI Black", 0, 13)); // NOI18N
        ...
        pBuscar.add(rbtNombreLista, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, -1, -1));
        ...
        pBuscar.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 420, 170));

        buttonGroup1.add(rbtusuario);
        rbtusuario.setFont(new java.awt.Font("Segoe UI Black", 0, 13)); // NOI18N
        rbtusuario.setText("usuario");
        pBuscar.add(rbtusuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 10, -1, -1));

        tablista.addTab("Buscar", pBuscar);

        pNuevo.setBackground(new java.awt.Color(102, 255, 204));
        ...
        txtIdLista.setBackground(new java.awt.Color(255, 204, 153));
        ...
        tablista.setBounds(0, 20, 460, 320);
        ...
        btnNuevo.setBounds(500, 60, 90, 25);
        ...
        btnGuardar.setBounds(500, 90, 90, 25);
        ...
        btnModificar.setBounds(500, 120, 90, 25);
        ...
        btnCancelar.setBounds(500, 150, 90, 25);
        ...
        btnSalir.setBounds(500, 180, 90, 25);
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        modificar();
        limpiarCampos();
        txtNombre.setText(FrmUsuario.strCodigoU);
        tblLista.setEnabled(false);
